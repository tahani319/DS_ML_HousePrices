...
```{r}
prepare <- prep(blueprint, training = house_train)
prepare
```
...
#### # Model concerns - multicollinearity
 ...
 we saw in EDA that sqft_above are highly correlated with sqft_living
...
so I will use priciple component regression to avoid multicollinearity 
